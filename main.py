...
while True:
    ...
    if student_name != "":
        ...
        print("Student name is null, please enter the valid name")
...
while True:
    ...
    if 2025 <= graduation_year <= 2027:
        ...
        print("Graduation year should be between 2025 and 2027, enter a valid year")
...
while True:
    ...
    if 0 <= attendance <= 100:
        ...
        print("Attendance should be between 0 to 100, enter a valid one !")
